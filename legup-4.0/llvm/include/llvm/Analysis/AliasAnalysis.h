...
public:
  ...
  enum ModRefBehavior {
    ...
    DoesNotAccessMemory = (int)Nowhere | (int)NoModRef,
    ...
    OnlyReadsArgumentPointees = (int)ArgumentPointees | Ref,
    ...
    OnlyAccessesArgumentPointees = (int)ArgumentPointees | ModRef,
    ...
    OnlyReadsMemory = (int)Anywhere | Ref,

    /// UnknownModRefBehavior - This indicates that the function could not be
    /// classified into one of the behaviors above.
    UnknownModRefBehavior = (int)Anywhere | ModRef
  };
  ...
  static bool onlyAccessesArgPointees(ModRefBehavior MRB) {
    return !((int)MRB & Anywhere & ~ArgumentPointees);
  }
  ...
  static bool doesAccessArgPointees(ModRefBehavior MRB) {
    return ((int)MRB & ModRef) && ((int)MRB & ArgumentPointees);
  }
