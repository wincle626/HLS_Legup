//===- IndVarSimplify2.cpp - Induction Variable Elimination ----------------===//
//
...
namespace {
  class IndVarSimplify2 : public LoopPass {
    IVUsers         *IU;
    LoopInfo        *LI;
    ScalarEvolution *SE;
    DominatorTree   *DT;
  ...
  public:
    ...
    IndVarSimplify2() : LoopPass(ID), IU(0), LI(0), SE(0), DT(0), TD(0),
                       Changed(false) {
      initializeIndVarSimplify2Pass(*PassRegistry::getPassRegistry());
    }
...
char IndVarSimplify2::ID = 0;
INITIALIZE_PASS_BEGIN(IndVarSimplify2, "indvars2",
                "Induction Variable Simplification, as in old llvm", false, false)
...
INITIALIZE_PASS_END(IndVarSimplify2, "indvars2",
                "Induction Variable Simplification, as in old llvm", false, false)

Pass *llvm::createIndVarSimplify2Pass() {
  return new IndVarSimplify2();
}
...
bool IndVarSimplify2::isValidRewrite(Value *FromVal, Value *ToVal) {
...
///   bar((double)i);
///
void IndVarSimplify2::HandleFloatingPointIV(Loop *L, PHINode *PN) {
...
void IndVarSimplify2::RewriteNonIntegerIVs(Loop *L) {
...
///
/// This is mostly redundant with the regular IndVarSimplify2 activities that
/// happen later, except that it's more powerful in some cases, because it's
/// able to brute-force evaluate arbitrary instructions as long as they have
/// constant operands at the beginning of the loop.
void IndVarSimplify2::RewriteLoopExitValues(Loop *L, SCEVExpander &Rewriter) {
...
void IndVarSimplify2::RewriteIVExpressions(Loop *L, SCEVExpander &Rewriter) {
...
namespace {
  ...
  public:
    ...
    WideIVVisitor(ScalarEvolution *SCEV, const DataLayout *TData) :
      SE(SCEV), TD(TData) {}
...
///
void IndVarSimplify2::SimplifyAndExtend(Loop *L,
...
///
void IndVarSimplify2::SimplifyCongruentIVs(Loop *L) {
...
LinearFunctionTestReplace(Loop *L,
  ...
  if (isPtrIV) {
      ...
      assert(SE->getSizeOfExpr(
			   /* TODO: LLVM 3.4 update: add this type, not sure if it is correct. */
               IVStart->getType(),
			   /* TODO: end change */
...
void IndVarSimplify2::SinkUnusedInvariants(Loop *L) {
...
//===----------------------------------------------------------------------===//
//  IndVarSimplify2 driver. Manage several subpasses of IV simplification.
//===----------------------------------------------------------------------===//

bool IndVarSimplify2::runOnLoop(Loop *L, LPPassManager &LPM) {
