...
void PassManagerBuilder::populateLTOPassManager(PassManagerBase &PM,
  ...
  // TODO: LLVM 3.5 update: comment out the InstructionCombiningPass because it
  // causes chstone/adpcm to generate error: "Error: memory address not aligned
  // to ram word size!" in pure HW case
