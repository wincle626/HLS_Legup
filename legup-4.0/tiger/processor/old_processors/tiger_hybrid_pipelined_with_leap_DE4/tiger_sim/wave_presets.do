...
# Display signals from module onchip_mem
add wave -noupdate -divider {onchip_mem}
add wave -noupdate -format Logic /test_bench/DUT/the_onchip_mem/chipselect
add wave -noupdate -format Logic /test_bench/DUT/the_onchip_mem/write
add wave -noupdate -format Literal -radix hexadecimal /test_bench/DUT/the_onchip_mem/address
add wave -noupdate -format Literal -radix binary /test_bench/DUT/the_onchip_mem/byteenable
add wave -noupdate -format Literal -radix hexadecimal /test_bench/DUT/the_onchip_mem/readdata
add wave -noupdate -format Literal -radix hexadecimal /test_bench/DUT/the_onchip_mem/writedata
