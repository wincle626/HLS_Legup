    set sopc "/home/choijon5/altera/10.1/quartus//sopc_builder"
    set sopc_perl "/home/choijon5/altera/10.1/quartus//linux/perl"
...
proc s_cycloneiv {} {
  if { [ expr ! [ string match "*ModelSim ALTERA*" [ vsim -version ] ] ] } {
    vlib work
    _init_setup
    set qsimlib /home/choijon5/altera/10.1/quartus/eda/sim_lib
    set v_files [ list \
