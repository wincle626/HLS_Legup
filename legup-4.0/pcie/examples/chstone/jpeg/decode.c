...
void
decode_start(unsigned char OutData_comp_buf[][BMP_OUT_SIZE], int* out_data_image_width, int* out_data_image_height, int* out_data_comp_vpos, int* out_data_comp_hpos)
{
    int i;
    int CurrentMCU = 0;
