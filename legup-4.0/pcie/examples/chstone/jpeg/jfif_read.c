...
void
jpeg_read(unsigned char *read_buf, unsigned char *write_buf, int *image_width_out, int *image_height_out)
{
     ...
     * Start decoding
     */
    decode_start(write_buf, image_width_out, image_height_out, &OutData_comp_vpos[0], &OutData_comp_hpos[0]);
