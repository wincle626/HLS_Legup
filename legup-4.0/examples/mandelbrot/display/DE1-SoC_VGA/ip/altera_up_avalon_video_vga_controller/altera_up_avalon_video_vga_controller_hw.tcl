...
set_parameter_property board ALLOWED_RANGES {DE0 DE1-SoC "DE2-115" "DE2i-150"}
...
proc validate {} {
	...
	if { $device == "LCD Screen (TRDB_LCM)" } {
		...
		} elseif { ($board == "DE1-SoC") || ($board == "DE2-115") || ($board == "DE2i-150") } {
...
proc elaborate {} {
	...
	# | 
#	set clk_freq		27.7
#	set clk_freq		[ expr [ get_interface_property "clock_reset" "clockRate" ] / 1000000.0 ]
	set clk_freq		[ expr {round([ expr [ get_interface_property "clock_reset" "clockRate" ] / 10000.0 ])} / 100.0 ]
