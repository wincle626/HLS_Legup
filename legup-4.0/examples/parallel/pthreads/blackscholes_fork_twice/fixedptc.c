...
fixedpt fixedpt_cos(fixedpt A) { return (fixedpt_sin(FIXEDPT_HALF_PI - A)); }
...
fixedpt fixedpt_exp(fixedpt fp) {
    ...
    //        printf("xp = FIXEDPT_ONE + fixedpt_div(fixedpt_mul(fp,
    //        FIXEDPT_TWO), R - fp); ");
    //        fixedpt_print(xp);
