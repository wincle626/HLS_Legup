...
static float64 addFloat64Sigs(float64 a, float64 b, flag zSign, int type) {
...
static float64 subFloat64Sigs(float64 a, float64 b, flag zSign, int type) {
    int16 aExp, bExp, zExp;
    bits64 aSig, bSig, zSig;
    int16 expDiff;
...
float64 float64_add(float64 a, float64 b, int type) {
    flag aSign, bSign;
...
float64 float64_mul(float64 a, float64 b, int type) {
...
float64 float64_div(float64 a, float64 b, int type) {
    flag aSign, bSign, zSign;
    int16 aExp, bExp, zExp;
    bits64 aSig, bSig, zSig;
...
flag float64_le(float64 a, float64 b, int type) {
    flag aSign, bSign;
...
flag float64_ge(float64 a, float64 b, int type) {
