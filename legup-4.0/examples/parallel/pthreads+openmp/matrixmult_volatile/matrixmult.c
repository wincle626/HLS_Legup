...
volatile int matrixA[INPUTA_MATRIXDIMENSION_Y][INPUTA_MATRIXDIMENSION_X] = {
...
// matrix B  [y][x]
volatile int matrixB[INPUTB_MATRIXDIMENSION_Y][INPUTB_MATRIXDIMENSION_X] = {
    {1, 2, 3, 4, 5, 6},
    {1, 2, 3, 4, 5, 6},
    {1, 2, 3, 4, 5, 6},
    {1, 2, 3, 4, 5, 6},
...
void *multiply(void *threadarg) {
    ...
    int result = 0;
    int tid;
#pragma omp parallel for num_threads(3) private(j, i, result)
