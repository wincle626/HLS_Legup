...
int main()
{
    //double p;
    int i, sum=0;   
	pthread_t threads[PTHREAD_ACCEL];
	int result[PTHREAD_ACCEL];

	//launch threads

	pthread_create(&threads[0], NULL, cordic64, NULL);
	pthread_create(&threads[1], NULL, cordic48, NULL);
	pthread_create(&threads[2], NULL, cordic32, NULL);
	pthread_create(&threads[3], NULL, cordic16, NULL);

/*
	pthread_create(&threads[0], NULL, cordic64, NULL);
	pthread_create(&threads[1], NULL, cordic32, NULL);
	pthread_create(&threads[2], NULL, cordic16, NULL);
	pthread_create(&threads[3], NULL, cordic8, NULL);*/
/*
	pthread_create(&threads[0], NULL, cordic64, NULL);
	pthread_create(&threads[1], NULL, cordic48, NULL);
	pthread_create(&threads[2], NULL, cordic32, NULL);
	pthread_create(&threads[3], NULL, cordic816, NULL);*/
	//join the threads
	for (i=0; i<PTHREAD_ACCEL; i++) {
