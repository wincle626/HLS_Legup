...
wire [3:0] memory_controller_address_a;
...
wire [3:0] memory_controller_address_b;
...
wire [3:0] funcB_memory_controller_address_a;
wire [3:0] funcB_memory_controller_address_b;
...
reg [31:0] memB_out_a_reg;
reg [31:0] memB_out_b_reg;
reg [31:0] memC_out_a_reg;
reg [31:0] memC_out_b_reg;
/*
...
parameter ram_latency = latency-1;
  ...
  altsyncram memC
    (
      .address_a (funcB_memory_controller_address_a | memC_address_a),
      .address_b (funcB_memory_controller_address_b | memC_address_b),
//      .addressstall_a (memory_controller_waitrequest),
//      .addressstall_b (memory_controller_waitrequest),
      .byteena_a (4'b1111),
      .byteena_b (4'b1111),
      .clock0 (clk),
      .clocken0 (!memory_controller_waitrequest),
      .data_a (funcB_memory_controller_in_a[31:0] | memC_in_a),
      .data_b (funcB_memory_controller_in_b[31:0] | memC_in_b),
      .q_a (memC_out_a),
      .q_b (memC_out_b),
      .wren_a (funcB_memory_controller_write_enable_a | memC_write_enable_a),
      .wren_b (funcB_memory_controller_write_enable_b | memC_write_enable_b)
    );

  defparam memC.address_reg_b = "CLOCK0",
           memC.byte_size = 8,
           memC.byteena_reg_b = "CLOCK0",
           memC.indata_reg_b = "CLOCK0",
           memC.init_file = "memC.mif",
           memC.lpm_type = "altsyncram",
           memC.maximum_depth = 10,
           memC.numwords_a = 10,
           memC.numwords_b = 10,
           memC.operation_mode = "BIDIR_DUAL_PORT",
           memC.outdata_reg_a = "UNREGISTERED",
           memC.outdata_reg_b = "UNREGISTERED",
           memC.ram_block_type = "AUTO",
           memC.read_during_write_mode_mixed_ports = "DONT_CARE",
           memC.width_a = 32,
           memC.width_b = 32,
           memC.width_byteena_a = 4,
           memC.width_byteena_b = 4,
           memC.widthad_a = 4,
           memC.widthad_b = 4,
           memC.wrcontrol_wraddress_reg_b = "CLOCK0";
/*       
// @memC = internal global [10 x i32] [i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9], align 4
ram_dual_port memC (
	.clk( clk ),
...
begin
memC_out_a_reg <= memC_out_a;
memC_out_b_reg <= memC_out_b;
end


  altsyncram memB
    (
      .address_a (memory_controller_address_a | memB_address_a),
      .address_b (memory_controller_address_b | memB_address_b),
//      .addressstall_a (memory_controller_waitrequest),
//      .addressstall_b (memory_controller_waitrequest),
      .byteena_a (4'b1111),
      .byteena_b (4'b1111),
      .clock0 (clk),
      .clocken0 (!memory_controller_waitrequest),
      .data_a (memory_controller_in_a[31:0] | memB_in_a),
      .data_b (memory_controller_in_b[31:0] | memB_in_b),
      .q_a (memB_out_a),
      .q_b (memB_out_b),
      .wren_a (memory_controller_write_enable_a | memB_write_enable_a ),
      .wren_b (memory_controller_write_enable_b | memB_write_enable_b )
    );

  defparam memB.address_reg_b = "CLOCK0",
           memB.byte_size = 8,
           memB.byteena_reg_b = "CLOCK0",
           memB.indata_reg_b = "CLOCK0",
           memB.init_file = "memB.mif",
           memB.lpm_type = "altsyncram",
           memB.maximum_depth = 10,
           memB.numwords_a = 10,
           memB.numwords_b = 10,
           memB.operation_mode = "BIDIR_DUAL_PORT",
           memB.outdata_reg_a = "UNREGISTERED",
           memB.outdata_reg_b = "UNREGISTERED",
           memB.ram_block_type = "AUTO",
           memB.read_during_write_mode_mixed_ports = "DONT_CARE",
           memB.width_a = 32,
           memB.width_b = 32,
           memB.width_byteena_a = 4,
           memB.width_byteena_b = 4,
           memB.widthad_a = 4,
           memB.widthad_b = 4,
           memB.wrcontrol_wraddress_reg_b = "CLOCK0";
/*
// @memB = internal global [10 x i32] zeroinitializer, align 4
ram_dual_port memB (
	.clk( clk ),
...
if (!memory_controller_waitrequest)
begin
memB_out_a_reg <= memB_out_a;
memB_out_b_reg <= memB_out_b;
end
...
main main_inst(
	...
	.memory_controller_out_a({32'd0, memB_out_a_reg}),
	.memory_controller_enable_b(memory_controller_enable_b),
	.memory_controller_address_b(memory_controller_address_b),
	.memory_controller_write_enable_b(memory_controller_write_enable_b),
	.memory_controller_in_b(memory_controller_in_b),
	.memory_controller_size_b(memory_controller_size_b),
	.memory_controller_out_b({32'd0, memB_out_b_reg}),
	.memory_controller_waitrequest(memory_controller_waitrequest),
...
funcA funcA (
    .memB_address_a(memB_address_a),
    .memB_enable_a(memB_enable_a),
    .memB_write_enable_a(memB_write_enable_a),
    .memB_in_a(memB_in_a),
    .memB_out_a(memB_out_a),
    .memB_address_b(memB_address_b),
    .memB_enable_b(memB_enable_b),
    .memB_write_enable_b(memB_write_enable_b),
    .memB_in_b(memB_in_b),
    .memB_out_b(memB_out_b),
    .memC_address_a(memC_address_a),
    .memC_enable_a(memC_enable_a),
    .memC_write_enable_a(memC_write_enable_a),
    .memC_in_a(memC_in_a),
    .memC_out_a(memC_out_a),
    .memC_address_b(memC_address_b),
    .memC_enable_b(memC_enable_b),
    .memC_write_enable_b(memC_write_enable_b),
    .memC_in_b(memC_in_b),
    .memC_out_b(memC_out_b),
	.memory_controller_waitrequest (memory_controller_waitrequest),
	.clk (clk),
	.clk2x (clk2x),
	.clk1x_follower (clk1x_follower),
...
funcB funcB (
	...
	.memory_controller_out_a ({32'd0, memC_out_a_reg}),
	...
	.memory_controller_out_b ({32'd0, memC_out_b_reg}),
	.memory_controller_waitrequest (memory_controller_waitrequest),
	.clk (clk),
	.clk2x (clk2x),
	.clk1x_follower (clk1x_follower),
...
input  start;
output reg  finish;
output reg  memory_controller_enable_a = 1;
output reg [3:0] memory_controller_address_a;
output reg  memory_controller_write_enable_a = 0;
output reg [`MEMORY_CONTROLLER_DATA_SIZE-1:0] memory_controller_in_a = 0;
output reg [1:0] memory_controller_size_a = 2;
input [`MEMORY_CONTROLLER_DATA_SIZE-1:0] memory_controller_out_a;
output reg  memory_controller_enable_b = 1;
output reg [3:0] memory_controller_address_b;
output reg  memory_controller_write_enable_b = 0;
output reg [`MEMORY_CONTROLLER_DATA_SIZE-1:0] memory_controller_in_b = 0;
output reg [1:0] memory_controller_size_b = 2;
...
assign memD_write_enable_a = 0;
assign memD_write_enable_b = 0;
...
always @(*) begin
	...
	/*   %1 = load volatile i32* getelementptr inbounds ([10 x i32]* @memC, i32 0, i32 0), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_funcB_BB_0_1)) begin
		memory_controller_address_a = (1'd0 >>> 3'd2);
	end
	/* funcB: %0*/
	/*   %8 = load volatile i32* getelementptr inbounds ([10 x i32]* @memC, i32 0, i32 2), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_funcB_BB_0_2)) begin
		memory_controller_address_a = ((1'd0 + (4 * 32'd2)) >>> 3'd2);
	end
	/* funcB: %0*/
	/*   %16 = load volatile i32* getelementptr inbounds ([10 x i32]* @memC, i32 0, i32 4), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_funcB_BB_0_3)) begin
		memory_controller_address_a = ((1'd0 + (4 * 32'd4)) >>> 3'd2);
	end
	/* funcB: %0*/
	/*   %24 = load volatile i32* getelementptr inbounds ([10 x i32]* @memC, i32 0, i32 6), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_funcB_BB_0_4)) begin
		memory_controller_address_a = ((1'd0 + (4 * 32'd6)) >>> 3'd2);
	end
	/* funcB: %0*/
	/*   %32 = load volatile i32* getelementptr inbounds ([10 x i32]* @memC, i32 0, i32 8), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_funcB_BB_0_5)) begin
		memory_controller_address_a = ((1'd0 + (4 * 32'd8)) >>> 3'd2);
	end
end
always @(*) begin
	...
	/*   %4 = load volatile i32* getelementptr inbounds ([10 x i32]* @memC, i32 0, i32 1), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_funcB_BB_0_1)) begin
		memory_controller_address_b = ((1'd0 + (4 * 32'd1)) >>> 3'd2);
	end
	/* funcB: %0*/
	/*   %12 = load volatile i32* getelementptr inbounds ([10 x i32]* @memC, i32 0, i32 3), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_funcB_BB_0_2)) begin
		memory_controller_address_b = ((1'd0 + (4 * 32'd3)) >>> 3'd2);
	end
	/* funcB: %0*/
	/*   %20 = load volatile i32* getelementptr inbounds ([10 x i32]* @memC, i32 0, i32 5), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_funcB_BB_0_3)) begin
		memory_controller_address_b = ((1'd0 + (4 * 32'd5)) >>> 3'd2);
	end
	/* funcB: %0*/
	/*   %28 = load volatile i32* getelementptr inbounds ([10 x i32]* @memC, i32 0, i32 7), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_funcB_BB_0_4)) begin
		memory_controller_address_b = ((1'd0 + (4 * 32'd7)) >>> 3'd2);
	end
	/* funcB: %0*/
	/*   %36 = load volatile i32* getelementptr inbounds ([10 x i32]* @memC, i32 0, i32 9), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_funcB_BB_0_5)) begin
		memory_controller_address_b = ((1'd0 + (4 * 32'd9)) >>> 3'd2);
	end
end
always @(posedge clk) begin
	if ((cur_state == LEGUP_0)) begin
...
output reg [3:0] memB_address_a;
output reg  memB_enable_a=0;
output reg  memB_write_enable_a=0;
output reg [31:0] memB_in_a=0;
input [31:0] memB_out_a;
output reg [3:0] memB_address_b;
output reg  memB_enable_b=0;
output reg  memB_write_enable_b=0;
output reg  [31:0] memB_in_b=0;
input [31:0] memB_out_b;
output reg [3:0] memC_address_a;
output reg  memC_enable_a=0;
output reg  memC_write_enable_a=0;
output reg [31:0] memC_in_a=0;
input [31:0] memC_out_a;
output reg [3:0] memC_address_b;
output reg  memC_enable_b=0;
output reg  memC_write_enable_b=0;
output reg [31:0] memC_in_b=0;
input [31:0] memC_out_b;
/*
...
/*
// @memB = internal global [10 x i32] [i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9], align 4
ram_dual_port memB (
	.clk( clk ),
	.clken( !memory_controller_waitrequest ),
	.address_a( memB_address_a ),
...
always @(posedge clk) begin
	...
	if (((cur_state == LEGUP_F_funcA_BB_0_8) & (memory_controller_waitrequest == 1'd0))) begin
		...
		if (start == 1'b0 && ^(LEGUP_function_call_9) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to cur_state"); $finish; end
	end
	if (((cur_state == LEGUP_function_call_9) & (memory_controller_waitrequest == 1'd1))) begin
		cur_state <= LEGUP_function_call_9;
		if (start == 1'b0 && ^(LEGUP_function_call_9) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to cur_state"); $finish; end
	end
	if ((((cur_state == LEGUP_function_call_9) & (memory_controller_waitrequest == 1'd0)) & (funcB_finish_final == 1'd1))) begin
	...
	if ((((cur_state == LEGUP_function_call_9) & (memory_controller_waitrequest == 1'd0)) & (funcB_finish_final == 1'd0))) begin
		cur_state <= LEGUP_function_call_9;
		if (start == 1'b0 && ^(LEGUP_function_call_9) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to cur_state"); $finish; end
	end
...
always @(*) begin
	/* funcA: %0*/
	/*   %14 = add i32 %12, %11*/
		funcA_0_14 = (funcA_0_12 + funcA_0_11);
end
always @(posedge clk) begin
	/* funcA: %0*/
	/*   %14 = add i32 %12, %11*/
...
always @(*) begin
	/* funcA: %0*/
	/*   %15 = add i32 %14, %13*/
		funcA_0_15 = (funcA_0_14_reg + funcA_0_13_reg);
end
always @(posedge clk) begin
	/* funcA: %0*/
	/*   %15 = add i32 %14, %13*/
...
always @(*) begin
	/* funcA: %0*/
	/*   %18 = add i32 %16, %15*/
		funcA_0_18 = (funcA_0_16 + funcA_0_15);
end
always @(posedge clk) begin
	/* funcA: %0*/
	/*   %18 = add i32 %16, %15*/
...
always @(*) begin
	/* funcA: %0*/
	/*   %22 = add i32 %20, %19*/
		funcA_0_22 = (funcA_0_20_reg + funcA_0_19_reg);
end
always @(posedge clk) begin
	/* funcA: %0*/
	/*   %22 = add i32 %20, %19*/
...
always @(*) begin
	/* funcA: %0*/
	/*   %23 = add i32 %22, %21*/
		funcA_0_23 = (funcA_0_22 + funcA_0_21_reg);
end
always @(posedge clk) begin
	/* funcA: %0*/
	/*   %23 = add i32 %22, %21*/
...
always @(*) begin
	/* funcA: %0*/
	/*   %26 = add i32 %24, %23*/
		funcA_0_26 = (funcA_0_24 + funcA_0_23);
end
always @(posedge clk) begin
	/* funcA: %0*/
	/*   %26 = add i32 %24, %23*/
...
always @(*) begin
	/* funcA: %0*/
	/*   %27 = add i32 %26, %25*/
		funcA_0_27 = (funcA_0_26_reg + funcA_0_25_reg);
end
always @(posedge clk) begin
	/* funcA: %0*/
	/*   %27 = add i32 %26, %25*/
...
always @(*) begin
	/* funcA: %0*/
	/*   %30 = add i32 %28, %27*/
		funcA_0_30 = (funcA_0_28_reg + funcA_0_27);
end
always @(posedge clk) begin
	/* funcA: %0*/
	/*   %30 = add i32 %28, %27*/
...
always @(*) begin
	/* funcA: %0*/
	/*   %31 = add i32 %30, %29*/
		funcA_0_31 = (funcA_0_30 + funcA_0_29_reg);
end
always @(posedge clk) begin
	/* funcA: %0*/
	/*   %31 = add i32 %30, %29*/
...
always @(*) begin
	/* funcA: %0*/
	/*   %34 = add i32 %32, %31*/
		funcA_0_34 = (funcA_0_32_reg + funcA_0_31_reg);
end
always @(posedge clk) begin
	/* funcA: %0*/
	/*   %34 = add i32 %32, %31*/
...
always @(*) begin
	/* funcA: %0*/
	/*   %35 = add i32 %34, %33*/
		funcA_0_35 = (funcA_0_34 + funcA_0_33_reg);
end
always @(posedge clk) begin
	/* funcA: %0*/
	/*   %35 = add i32 %34, %33*/
...
always @(*) begin
	/* funcA: %0*/
	/*   %38 = add i32 %36, %35*/
		funcA_0_38 = (funcA_0_36_reg + funcA_0_35);
end
always @(posedge clk) begin
	/* funcA: %0*/
	/*   %38 = add i32 %36, %35*/
...
always @(*) begin
	/* funcA: %0*/
	/*   %39 = add i32 %38, %37*/
		funcA_0_39 = (funcA_0_38_reg + funcA_0_37_reg);
end
always @(posedge clk) begin
	/* funcA: %0*/
	/*   %39 = add i32 %38, %37*/
...
always @(*) begin
	...
	if ((cur_state == LEGUP_F_funcA_BB_0_1)) begin
		memB_address_a = (1'd0 >>> 3'd2);
	end
	/* funcA: %0*/
	/*   %8 = load volatile i32* getelementptr inbounds ([10 x i32]* @memB, i32 0, i32 2), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_funcA_BB_0_2)) begin
		memB_address_a = ((1'd0 + (4 * 32'd2)) >>> 3'd2);
	end
	/* funcA: %0*/
	/*   %16 = load volatile i32* getelementptr inbounds ([10 x i32]* @memB, i32 0, i32 4), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_funcA_BB_0_3)) begin
		memB_address_a = ((1'd0 + (4 * 32'd4)) >>> 3'd2);
	end
	/* funcA: %0*/
	/*   %24 = load volatile i32* getelementptr inbounds ([10 x i32]* @memB, i32 0, i32 6), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_funcA_BB_0_4)) begin
		memB_address_a = ((1'd0 + (4 * 32'd6)) >>> 3'd2);
	end
	/* funcA: %0*/
	/*   %32 = load volatile i32* getelementptr inbounds ([10 x i32]* @memB, i32 0, i32 8), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_funcA_BB_0_5)) begin
		memB_address_a = ((1'd0 + (4 * 32'd8)) >>> 3'd2);
	end
end
always @(*) begin
	memB_address_b = 1'd0;
	...
	/*   %4 = load volatile i32* getelementptr inbounds ([10 x i32]* @memB, i32 0, i32 1), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_funcA_BB_0_1)) begin
		memB_address_b = ((1'd0 + (4 * 32'd1)) >>> 3'd2);
	end
	/* funcA: %0*/
	/*   %12 = load volatile i32* getelementptr inbounds ([10 x i32]* @memB, i32 0, i32 3), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_funcA_BB_0_2)) begin
		memB_address_b = ((1'd0 + (4 * 32'd3)) >>> 3'd2);
	end
	/* funcA: %0*/
	/*   %20 = load volatile i32* getelementptr inbounds ([10 x i32]* @memB, i32 0, i32 5), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_funcA_BB_0_3)) begin
		memB_address_b = ((1'd0 + (4 * 32'd5)) >>> 3'd2);
	end
	/* funcA: %0*/
	/*   %28 = load volatile i32* getelementptr inbounds ([10 x i32]* @memB, i32 0, i32 7), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_funcA_BB_0_4)) begin
		memB_address_b = ((1'd0 + (4 * 32'd7)) >>> 3'd2);
	end
	/* funcA: %0*/
	/*   %36 = load volatile i32* getelementptr inbounds ([10 x i32]* @memB, i32 0, i32 9), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_funcA_BB_0_5)) begin
		memB_address_b = ((1'd0 + (4 * 32'd9)) >>> 3'd2);
	end
end
always @(*) begin
	memC_address_a = 1'd0;
	...
	/*   %2 = load volatile i32* getelementptr inbounds ([10 x i32]* @memC, i32 0, i32 0), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_funcA_BB_0_1)) begin
		memC_address_a = (1'd0 >>> 3'd2);
	end
	/* funcA: %0*/
	/*   %9 = load volatile i32* getelementptr inbounds ([10 x i32]* @memC, i32 0, i32 2), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_funcA_BB_0_2)) begin
		memC_address_a = ((1'd0 + (4 * 32'd2)) >>> 3'd2);
	end
	/* funcA: %0*/
	/*   %17 = load volatile i32* getelementptr inbounds ([10 x i32]* @memC, i32 0, i32 4), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_funcA_BB_0_3)) begin
		memC_address_a = ((1'd0 + (4 * 32'd4)) >>> 3'd2);
	end
	/* funcA: %0*/
	/*   %25 = load volatile i32* getelementptr inbounds ([10 x i32]* @memC, i32 0, i32 6), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_funcA_BB_0_4)) begin
		memC_address_a = ((1'd0 + (4 * 32'd6)) >>> 3'd2);
	end
	/* funcA: %0*/
	/*   %33 = load volatile i32* getelementptr inbounds ([10 x i32]* @memC, i32 0, i32 8), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_funcA_BB_0_5)) begin
		memC_address_a = ((1'd0 + (4 * 32'd8)) >>> 3'd2);
	end
end
always @(*) begin
	memC_address_b = 1'd0;
	...
	/*   %5 = load volatile i32* getelementptr inbounds ([10 x i32]* @memC, i32 0, i32 1), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_funcA_BB_0_1)) begin
		memC_address_b = ((1'd0 + (4 * 32'd1)) >>> 3'd2);
	end
	/* funcA: %0*/
	/*   %13 = load volatile i32* getelementptr inbounds ([10 x i32]* @memC, i32 0, i32 3), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_funcA_BB_0_2)) begin
		memC_address_b = ((1'd0 + (4 * 32'd3)) >>> 3'd2);
	end
	/* funcA: %0*/
	/*   %21 = load volatile i32* getelementptr inbounds ([10 x i32]* @memC, i32 0, i32 5), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_funcA_BB_0_3)) begin
		memC_address_b = ((1'd0 + (4 * 32'd5)) >>> 3'd2);
	end
	/* funcA: %0*/
	/*   %29 = load volatile i32* getelementptr inbounds ([10 x i32]* @memC, i32 0, i32 7), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_funcA_BB_0_4)) begin
		memC_address_b = ((1'd0 + (4 * 32'd7)) >>> 3'd2);
	end
	/* funcA: %0*/
	/*   %37 = load volatile i32* getelementptr inbounds ([10 x i32]* @memC, i32 0, i32 9), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_funcA_BB_0_5)) begin
		memC_address_b = ((1'd0 + (4 * 32'd9)) >>> 3'd2);
	end
end
always @(posedge clk) begin
	/* funcA: %0*/
...
always @(posedge clk) begin
	if ((reset | (cur_state == LEGUP_F_funcA_BB_0_8))) begin
...
reg  memA_write_enable_a = 0;
wire [31:0] memA_in_a;
wire [31:0] memA_out_a;
reg [3:0] memA_address_b;
reg  memA_write_enable_b = 0;
wire [31:0] memA_in_b;
wire [31:0] memA_out_b;
wire [3:0] memC_address_a;
wire  memC_write_enable_a;
