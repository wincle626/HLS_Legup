...
`define TAG_g_memA `MEMORY_CONTROLLER_TAG_SIZE'd2
`define TAG_g_memA_a {`TAG_g_memA, 23'd0}
// @memB = internal global [10 x i32] zeroinitializer, align 4
`define TAG_g_memB `MEMORY_CONTROLLER_TAG_SIZE'd5
...
`define TAG_g_memC `MEMORY_CONTROLLER_TAG_SIZE'd3
...
`define TAG_g_memD `MEMORY_CONTROLLER_TAG_SIZE'd4
`define TAG_g_memD_a {`TAG_g_memD, 23'd0}
...
defparam memA.latency = ram_latency;
...
defparam memD.latency = ram_latency;
...
wire select_memA_a;
assign select_memA_a = (tag_a == `TAG_g_memA);
reg [ram_latency:0] select_memA_reg_a;
wire [31:0] memory_controller_memA_out_a;
assign memory_controller_memA_out_a = {32{ select_memA_reg_a[ram_latency]}} & memA_out_a;
...
wire select_memD_a;
assign select_memD_a = (tag_a == `TAG_g_memD);
reg [ram_latency:0] select_memD_reg_a;
wire [31:0] memory_controller_memD_out_a;
assign memory_controller_memD_out_a = {32{ select_memD_reg_a[ram_latency]}} & memD_out_a;
...
always @(*)
begin
	memA_address_a = memory_controller_address_a [4-1+2:2] & {4{select_memA_a}};
	memA_write_enable_a = memory_controller_write_enable_a & select_memA_a;
	memA_in_a [32-1:0] = memory_controller_in_a[32-1:0];
	...
	memD_address_a = memory_controller_address_a [4-1+2:2] & {4{select_memD_a}};
	memD_write_enable_a = memory_controller_write_enable_a & select_memD_a;
	memD_in_a [32-1:0] = memory_controller_in_a[32-1:0];
...
always @(*)
begin
	select_not_struct_a [2:0] = 3'b0 | {2{select_memA_reg_a[ram_latency]}} | {2{select_memC_reg_a[ram_latency]}} | {2{select_memD_reg_a[ram_latency]}} | {2{select_memB_reg_a[ram_latency]}};
	...
	memory_controller_out_a = 1'b0 | memory_controller_out_prev_a | memory_controller_memA_out_a | memory_controller_memC_out_a | memory_controller_memD_out_a | memory_controller_memB_out_a;
end
...
begin
select_memA_reg_a[j+1] <= select_memA_reg_a[j];
select_memC_reg_a[j+1] <= select_memC_reg_a[j];
select_memD_reg_a[j+1] <= select_memD_reg_a[j];
select_memB_reg_a[j+1] <= select_memB_reg_a[j];
end
always @(*)
begin
select_memA_reg_a[0] <= select_memA_a;
select_memC_reg_a[0] <= select_memC_a;
select_memD_reg_a[0] <= select_memD_a;
...
wire select_memA_b;
assign select_memA_b = (tag_b == `TAG_g_memA);
reg [ram_latency:0] select_memA_reg_b;
wire [31:0] memory_controller_memA_out_b;
assign memory_controller_memA_out_b = {32{ select_memA_reg_b[ram_latency]}} & memA_out_b;
...
wire select_memD_b;
assign select_memD_b = (tag_b == `TAG_g_memD);
reg [ram_latency:0] select_memD_reg_b;
wire [31:0] memory_controller_memD_out_b;
assign memory_controller_memD_out_b = {32{ select_memD_reg_b[ram_latency]}} & memD_out_b;
...
always @(*)
begin
	memA_address_b = memory_controller_address_b [4-1+2:2] & {4{select_memA_b}};
	memA_write_enable_b = memory_controller_write_enable_b & select_memA_b;
	memA_in_b [32-1:0] = memory_controller_in_b[32-1:0];
	...
	memD_address_b = memory_controller_address_b [4-1+2:2] & {4{select_memD_b}};
	memD_write_enable_b = memory_controller_write_enable_b & select_memD_b;
	memD_in_b [32-1:0] = memory_controller_in_b[32-1:0];
...
always @(*)
begin
	select_not_struct_b [2:0] = 3'b0 | {2{select_memA_reg_b[ram_latency]}} | {2{select_memC_reg_b[ram_latency]}} | {2{select_memD_reg_b[ram_latency]}} | {2{select_memB_reg_b[ram_latency]}};
	...
	memory_controller_out_b = 1'b0 | memory_controller_out_prev_b | memory_controller_memA_out_b | memory_controller_memC_out_b | memory_controller_memD_out_b | memory_controller_memB_out_b;
end
...
for (j = 0; j < ram_latency; j=j+1)
begin
select_memA_reg_b[j+1] <= select_memA_reg_b[j];
select_memC_reg_b[j+1] <= select_memC_reg_b[j];
select_memD_reg_b[j+1] <= select_memD_reg_b[j];
select_memB_reg_b[j+1] <= select_memB_reg_b[j];
end
always @(*)
begin
select_memA_reg_b[0] <= select_memA_b;
select_memC_reg_b[0] <= select_memC_b;
select_memD_reg_b[0] <= select_memD_b;
...
parameter [3:0] LEGUP_F_funcB_BB_0_10 = 4'd10;
parameter [3:0] LEGUP_F_funcB_BB_0_11 = 4'd11;
parameter [3:0] LEGUP_F_funcB_BB_0_12 = 4'd12;
...
always @(posedge clk) begin
	...
	if (((cur_state == LEGUP_F_funcB_BB_0_9) & (memory_controller_waitrequest == 1'd0))) begin
		cur_state <= LEGUP_F_funcB_BB_0_10;
		if (start == 1'b0 && ^(LEGUP_F_funcB_BB_0_10) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to cur_state"); $finish; end
	end
	if (((cur_state == LEGUP_F_funcB_BB_0_10) & (memory_controller_waitrequest == 1'd1))) begin
		cur_state <= LEGUP_F_funcB_BB_0_10;
		if (start == 1'b0 && ^(LEGUP_F_funcB_BB_0_10) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to cur_state"); $finish; end
	end
	if (((cur_state == LEGUP_F_funcB_BB_0_10) & (memory_controller_waitrequest == 1'd0))) begin
		cur_state <= LEGUP_F_funcB_BB_0_11;
		if (start == 1'b0 && ^(LEGUP_F_funcB_BB_0_11) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to cur_state"); $finish; end
	end
	if (((cur_state == LEGUP_F_funcB_BB_0_11) & (memory_controller_waitrequest == 1'd1))) begin
		cur_state <= LEGUP_F_funcB_BB_0_11;
		if (start == 1'b0 && ^(LEGUP_F_funcB_BB_0_11) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to cur_state"); $finish; end
	end
	if (((cur_state == LEGUP_F_funcB_BB_0_11) & (memory_controller_waitrequest == 1'd0))) begin
		cur_state <= LEGUP_F_funcB_BB_0_12;
		if (start == 1'b0 && ^(LEGUP_F_funcB_BB_0_12) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to cur_state"); $finish; end
	end
	if (((cur_state == LEGUP_F_funcB_BB_0_12) & (memory_controller_waitrequest == 1'd1))) begin
		cur_state <= LEGUP_F_funcB_BB_0_12;
		if (start == 1'b0 && ^(LEGUP_F_funcB_BB_0_12) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to cur_state"); $finish; end
	end
	if (((cur_state == LEGUP_F_funcB_BB_0_12) & (memory_controller_waitrequest == 1'd0))) begin
		cur_state <= LEGUP_0;
		if (start == 1'b0 && ^(LEGUP_0) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to cur_state"); $finish; end
	end
	if ((reset == 1'd1)) begin
...
always @(*) begin
	...
	/*   %2 = load volatile i32* getelementptr inbounds ([10 x i32]* @memD, i32 0, i32 0), align 4, !tbaa !1*/
		funcB_0_2 = memory_controller_out_b[31:0];
end
always @(*) begin
	/* funcB: %0*/
	/*   %3 = add i32 %1, %2*/
		funcB_0_3 = (funcB_0_1 + funcB_0_2);
end
always @(posedge clk) begin
	/* funcB: %0*/
	/*   %3 = add i32 %1, %2*/
...
always @(*) begin
	...
	/*   %4 = load volatile i32* getelementptr inbounds ([10 x i32]* @memC, i32 0, i32 1), align 4, !tbaa !1*/
		funcB_0_4 = memory_controller_out_a[31:0];
end
always @(*) begin
	/* funcB: %0*/
	/*   %5 = load volatile i32* getelementptr inbounds ([10 x i32]* @memD, i32 0, i32 1), align 4, !tbaa !1*/
		funcB_0_5 = memory_controller_out_b[31:0];
end
always @(*) begin
	/* funcB: %0*/
	/*   %6 = add i32 %4, %3*/
		funcB_0_6 = (funcB_0_4 + funcB_0_3_reg);
end
always @(*) begin
	/* funcB: %0*/
	/*   %7 = add i32 %6, %5*/
		funcB_0_7 = (funcB_0_6 + funcB_0_5);
end
always @(posedge clk) begin
	/* funcB: %0*/
	/*   %7 = add i32 %6, %5*/
...
always @(*) begin
	...
	/*   %9 = load volatile i32* getelementptr inbounds ([10 x i32]* @memD, i32 0, i32 2), align 4, !tbaa !1*/
		funcB_0_9 = memory_controller_out_b[31:0];
end
always @(*) begin
	/* funcB: %0*/
	/*   %10 = add i32 %8, %7*/
...
always @(*) begin
	/* funcB: %0*/
	/*   %11 = add i32 %10, %9*/
		funcB_0_11 = (funcB_0_10 + funcB_0_9);
end
always @(posedge clk) begin
	/* funcB: %0*/
	/*   %11 = add i32 %10, %9*/
...
always @(*) begin
	...
	/*   %12 = load volatile i32* getelementptr inbounds ([10 x i32]* @memC, i32 0, i32 3), align 4, !tbaa !1*/
		funcB_0_12 = memory_controller_out_a[31:0];
end
always @(*) begin
	/* funcB: %0*/
	/*   %13 = load volatile i32* getelementptr inbounds ([10 x i32]* @memD, i32 0, i32 3), align 4, !tbaa !1*/
		funcB_0_13 = memory_controller_out_b[31:0];
end
always @(*) begin
	/* funcB: %0*/
	/*   %14 = add i32 %12, %11*/
		funcB_0_14 = (funcB_0_12 + funcB_0_11_reg);
end
always @(*) begin
	/* funcB: %0*/
	/*   %15 = add i32 %14, %13*/
		funcB_0_15 = (funcB_0_14 + funcB_0_13);
end
always @(posedge clk) begin
	/* funcB: %0*/
	/*   %15 = add i32 %14, %13*/
...
always @(*) begin
	...
	/*   %17 = load volatile i32* getelementptr inbounds ([10 x i32]* @memD, i32 0, i32 4), align 4, !tbaa !1*/
		funcB_0_17 = memory_controller_out_b[31:0];
end
always @(*) begin
	/* funcB: %0*/
	/*   %18 = add i32 %16, %15*/
		funcB_0_18 = (funcB_0_16 + funcB_0_15_reg);
end
always @(*) begin
	/* funcB: %0*/
	/*   %19 = add i32 %18, %17*/
		funcB_0_19 = (funcB_0_18 + funcB_0_17);
end
always @(posedge clk) begin
	/* funcB: %0*/
	/*   %19 = add i32 %18, %17*/
...
always @(*) begin
	...
	/*   %20 = load volatile i32* getelementptr inbounds ([10 x i32]* @memC, i32 0, i32 5), align 4, !tbaa !1*/
		funcB_0_20 = memory_controller_out_a[31:0];
end
always @(*) begin
	/* funcB: %0*/
	/*   %21 = load volatile i32* getelementptr inbounds ([10 x i32]* @memD, i32 0, i32 5), align 4, !tbaa !1*/
		funcB_0_21 = memory_controller_out_b[31:0];
end
always @(*) begin
	/* funcB: %0*/
	/*   %22 = add i32 %20, %19*/
		funcB_0_22 = (funcB_0_20 + funcB_0_19_reg);
end
always @(*) begin
	/* funcB: %0*/
	/*   %23 = add i32 %22, %21*/
		funcB_0_23 = (funcB_0_22 + funcB_0_21);
end
always @(posedge clk) begin
	/* funcB: %0*/
	/*   %23 = add i32 %22, %21*/
...
always @(*) begin
	...
	/*   %25 = load volatile i32* getelementptr inbounds ([10 x i32]* @memD, i32 0, i32 6), align 4, !tbaa !1*/
		funcB_0_25 = memory_controller_out_b[31:0];
end
always @(*) begin
	/* funcB: %0*/
	/*   %26 = add i32 %24, %23*/
		funcB_0_26 = (funcB_0_24 + funcB_0_23_reg);
end
always @(*) begin
	/* funcB: %0*/
	/*   %27 = add i32 %26, %25*/
		funcB_0_27 = (funcB_0_26 + funcB_0_25);
end
always @(posedge clk) begin
	/* funcB: %0*/
	/*   %27 = add i32 %26, %25*/
...
always @(*) begin
	...
	/*   %28 = load volatile i32* getelementptr inbounds ([10 x i32]* @memC, i32 0, i32 7), align 4, !tbaa !1*/
		funcB_0_28 = memory_controller_out_a[31:0];
end
always @(*) begin
	/* funcB: %0*/
	/*   %29 = load volatile i32* getelementptr inbounds ([10 x i32]* @memD, i32 0, i32 7), align 4, !tbaa !1*/
		funcB_0_29 = memory_controller_out_b[31:0];
end
always @(*) begin
	/* funcB: %0*/
	/*   %30 = add i32 %28, %27*/
		funcB_0_30 = (funcB_0_28 + funcB_0_27_reg);
end
always @(*) begin
	/* funcB: %0*/
	/*   %31 = add i32 %30, %29*/
		funcB_0_31 = (funcB_0_30 + funcB_0_29);
end
always @(posedge clk) begin
	/* funcB: %0*/
	/*   %31 = add i32 %30, %29*/
	if ((cur_state == LEGUP_F_funcB_BB_0_10)) begin
...
always @(*) begin
	...
	/*   %33 = load volatile i32* getelementptr inbounds ([10 x i32]* @memD, i32 0, i32 8), align 4, !tbaa !1*/
		funcB_0_33 = memory_controller_out_b[31:0];
end
always @(*) begin
	/* funcB: %0*/
	/*   %34 = add i32 %32, %31*/
		funcB_0_34 = (funcB_0_32 + funcB_0_31_reg);
end
always @(*) begin
	/* funcB: %0*/
	/*   %35 = add i32 %34, %33*/
		funcB_0_35 = (funcB_0_34 + funcB_0_33);
end
always @(posedge clk) begin
	/* funcB: %0*/
	/*   %35 = add i32 %34, %33*/
	if ((cur_state == LEGUP_F_funcB_BB_0_11)) begin
...
always @(*) begin
	...
	/*   %36 = load volatile i32* getelementptr inbounds ([10 x i32]* @memC, i32 0, i32 9), align 4, !tbaa !1*/
		funcB_0_36 = memory_controller_out_a[31:0];
end
always @(*) begin
	/* funcB: %0*/
	/*   %37 = load volatile i32* getelementptr inbounds ([10 x i32]* @memD, i32 0, i32 9), align 4, !tbaa !1*/
		funcB_0_37 = memory_controller_out_b[31:0];
end
always @(*) begin
	/* funcB: %0*/
	/*   %38 = add i32 %36, %35*/
		funcB_0_38 = (funcB_0_36 + funcB_0_35_reg);
end
always @(*) begin
	/* funcB: %0*/
	/*   %39 = add i32 %38, %37*/
		funcB_0_39 = (funcB_0_38 + funcB_0_37);
end
always @(*) begin
	/* funcB: %0*/
...
always @(posedge clk) begin
	...
	/* funcB: %0*/
	/*   ret i32 %40*/
	if ((cur_state == LEGUP_F_funcB_BB_0_12)) begin
...
always @(*) begin
	...
	/*   %4 = load volatile i32* getelementptr inbounds ([10 x i32]* @memC, i32 0, i32 1), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_funcB_BB_0_2)) begin
		memory_controller_address_a = (`TAG_g_memC_a + (4 * 32'd1));
	end
	/* funcB: %0*/
	/*   %8 = load volatile i32* getelementptr inbounds ([10 x i32]* @memC, i32 0, i32 2), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_funcB_BB_0_3)) begin
	...
	/*   %12 = load volatile i32* getelementptr inbounds ([10 x i32]* @memC, i32 0, i32 3), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_funcB_BB_0_4)) begin
		memory_controller_address_a = (`TAG_g_memC_a + (4 * 32'd3));
	end
	/* funcB: %0*/
	/*   %16 = load volatile i32* getelementptr inbounds ([10 x i32]* @memC, i32 0, i32 4), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_funcB_BB_0_5)) begin
	...
	/*   %20 = load volatile i32* getelementptr inbounds ([10 x i32]* @memC, i32 0, i32 5), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_funcB_BB_0_6)) begin
		memory_controller_address_a = (`TAG_g_memC_a + (4 * 32'd5));
	end
	/* funcB: %0*/
	/*   %24 = load volatile i32* getelementptr inbounds ([10 x i32]* @memC, i32 0, i32 6), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_funcB_BB_0_7)) begin
	...
	/*   %28 = load volatile i32* getelementptr inbounds ([10 x i32]* @memC, i32 0, i32 7), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_funcB_BB_0_8)) begin
		memory_controller_address_a = (`TAG_g_memC_a + (4 * 32'd7));
	end
	/* funcB: %0*/
	/*   %32 = load volatile i32* getelementptr inbounds ([10 x i32]* @memC, i32 0, i32 8), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_funcB_BB_0_9)) begin
	...
	/*   %36 = load volatile i32* getelementptr inbounds ([10 x i32]* @memC, i32 0, i32 9), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_funcB_BB_0_10)) begin
		memory_controller_address_a = (`TAG_g_memC_a + (4 * 32'd9));
	end
end
always @(*) begin
...
always @(*) begin
	...
	/*   %2 = load volatile i32* getelementptr inbounds ([10 x i32]* @memD, i32 0, i32 0), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_funcB_BB_0_1)) begin
		memory_controller_address_b = `TAG_g_memD_a;
	end
	/* funcB: %0*/
	/*   %5 = load volatile i32* getelementptr inbounds ([10 x i32]* @memD, i32 0, i32 1), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_funcB_BB_0_2)) begin
		memory_controller_address_b = (`TAG_g_memD_a + (4 * 32'd1));
	end
	/* funcB: %0*/
	/*   %9 = load volatile i32* getelementptr inbounds ([10 x i32]* @memD, i32 0, i32 2), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_funcB_BB_0_3)) begin
		memory_controller_address_b = (`TAG_g_memD_a + (4 * 32'd2));
	end
	/* funcB: %0*/
	/*   %13 = load volatile i32* getelementptr inbounds ([10 x i32]* @memD, i32 0, i32 3), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_funcB_BB_0_4)) begin
		memory_controller_address_b = (`TAG_g_memD_a + (4 * 32'd3));
	end
	/* funcB: %0*/
	/*   %17 = load volatile i32* getelementptr inbounds ([10 x i32]* @memD, i32 0, i32 4), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_funcB_BB_0_5)) begin
		memory_controller_address_b = (`TAG_g_memD_a + (4 * 32'd4));
	end
	/* funcB: %0*/
	/*   %21 = load volatile i32* getelementptr inbounds ([10 x i32]* @memD, i32 0, i32 5), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_funcB_BB_0_6)) begin
		memory_controller_address_b = (`TAG_g_memD_a + (4 * 32'd5));
	end
	/* funcB: %0*/
	/*   %25 = load volatile i32* getelementptr inbounds ([10 x i32]* @memD, i32 0, i32 6), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_funcB_BB_0_7)) begin
		memory_controller_address_b = (`TAG_g_memD_a + (4 * 32'd6));
	end
	/* funcB: %0*/
	/*   %29 = load volatile i32* getelementptr inbounds ([10 x i32]* @memD, i32 0, i32 7), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_funcB_BB_0_8)) begin
		memory_controller_address_b = (`TAG_g_memD_a + (4 * 32'd7));
	end
	/* funcB: %0*/
	/*   %33 = load volatile i32* getelementptr inbounds ([10 x i32]* @memD, i32 0, i32 8), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_funcB_BB_0_9)) begin
		memory_controller_address_b = (`TAG_g_memD_a + (4 * 32'd8));
	end
	/* funcB: %0*/
	/*   %37 = load volatile i32* getelementptr inbounds ([10 x i32]* @memD, i32 0, i32 9), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_funcB_BB_0_10)) begin
		memory_controller_address_b = (`TAG_g_memD_a + (4 * 32'd9));
	end
end
always @(*) begin
...
always @(*) begin
	...
	/*   %40 = tail call fastcc i32 @funcB(i32 %39) #2*/
	if ((cur_state == LEGUP_function_call_13)) begin
		memory_controller_address_a[`MEMORY_CONTROLLER_ADDR_SIZE-1:0] = funcB_memory_controller_address_a;
	end
	/* funcA: %0*/
	/*   %40 = tail call fastcc i32 @funcB(i32 %39) #2*/
	if ((cur_state == LEGUP_function_call_13)) begin
...
always @(*) begin
	...
	/*   %40 = tail call fastcc i32 @funcB(i32 %39) #2*/
	if ((cur_state == LEGUP_function_call_13)) begin
		memory_controller_in_a[`MEMORY_CONTROLLER_DATA_SIZE-1:0] = funcB_memory_controller_in_a;
	end
	/* funcA: %0*/
	/*   %40 = tail call fastcc i32 @funcB(i32 %39) #2*/
	if ((cur_state == LEGUP_function_call_13)) begin
...
always @(*) begin
	memory_controller_size_a = 1'd0;
	if ((cur_state == LEGUP_function_call_13)) begin
		memory_controller_size_a[1:0] = funcB_memory_controller_size_a;
	end
	/* funcA: %0*/
	/*   %40 = tail call fastcc i32 @funcB(i32 %39) #2*/
	if ((cur_state == LEGUP_function_call_13)) begin
...
always @(*) begin
	...
	/*   %40 = tail call fastcc i32 @funcB(i32 %39) #2*/
	if ((cur_state == LEGUP_function_call_13)) begin
		memory_controller_address_b[`MEMORY_CONTROLLER_ADDR_SIZE-1:0] = funcB_memory_controller_address_b;
	end
	/* funcA: %0*/
	/*   %40 = tail call fastcc i32 @funcB(i32 %39) #2*/
	if ((cur_state == LEGUP_function_call_13)) begin
...
always @(*) begin
	...
	/*   %40 = tail call fastcc i32 @funcB(i32 %39) #2*/
	if ((cur_state == LEGUP_function_call_13)) begin
		memory_controller_in_b[`MEMORY_CONTROLLER_DATA_SIZE-1:0] = funcB_memory_controller_in_b;
	end
	/* funcA: %0*/
	/*   %40 = tail call fastcc i32 @funcB(i32 %39) #2*/
	if ((cur_state == LEGUP_function_call_13)) begin
...
always @(*) begin
	memory_controller_size_b = 1'd0;
	if ((cur_state == LEGUP_function_call_13)) begin
		memory_controller_size_b[1:0] = funcB_memory_controller_size_b;
	end
	/* funcA: %0*/
	/*   %40 = tail call fastcc i32 @funcB(i32 %39) #2*/
	if ((cur_state == LEGUP_function_call_13)) begin
...
parameter [4:0] LEGUP_F_main_BB_0_2 = 5'd2;
parameter [4:0] LEGUP_F_main_BB_0_3 = 5'd3;
parameter [4:0] LEGUP_F_main_BB_0_4 = 5'd4;
parameter [4:0] LEGUP_F_main_BB_0_5 = 5'd5;
parameter [4:0] LEGUP_F_main_BB_0_6 = 5'd6;
parameter [4:0] LEGUP_F_main_BB_0_7 = 5'd7;
parameter [4:0] LEGUP_F_main_BB_0_8 = 5'd8;
parameter [4:0] LEGUP_F_main_BB_0_9 = 5'd9;
parameter [4:0] LEGUP_F_main_BB_0_10 = 5'd10;
parameter [4:0] LEGUP_F_main_BB_0_11 = 5'd11;
parameter [4:0] LEGUP_F_main_BB_0_13 = 5'd13;
parameter [4:0] LEGUP_F_main_BB_14_14 = 5'd14;
parameter [4:0] LEGUP_F_main_BB_16_15 = 5'd15;
parameter [4:0] LEGUP_F_main_BB_18_16 = 5'd16;
parameter [8:0] tag_offset = 9'd0;
parameter [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] tag_addr_offset = {tag_offset, 23'd0};
...
always @(posedge clk)
	...
	if ((cur_state == LEGUP_F_main_BB_0_13)) begin
	...
	if ((cur_state == LEGUP_F_main_BB_14_14)) begin
		$write("RESULT: PASS\n");
	end
	/* main: %16*/
	/*   %17 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str2, i32 0, i32 0)) #3*/
	if ((cur_state == LEGUP_F_main_BB_16_15)) begin
		$write("RESULT: FAIL\n");
	end
end
always @(posedge clk) begin
	...
	if (((cur_state == LEGUP_F_main_BB_0_7) & (memory_controller_waitrequest == 1'd0))) begin
		cur_state <= LEGUP_F_main_BB_0_8;
		if (start == 1'b0 && ^(LEGUP_F_main_BB_0_8) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to cur_state"); $finish; end
	end
	if (((cur_state == LEGUP_F_main_BB_0_8) & (memory_controller_waitrequest == 1'd1))) begin
		cur_state <= LEGUP_F_main_BB_0_8;
		if (start == 1'b0 && ^(LEGUP_F_main_BB_0_8) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to cur_state"); $finish; end
	end
	if (((cur_state == LEGUP_F_main_BB_0_8) & (memory_controller_waitrequest == 1'd0))) begin
	...
	if (((cur_state == LEGUP_F_main_BB_0_9) & (memory_controller_waitrequest == 1'd0))) begin
		cur_state <= LEGUP_F_main_BB_0_10;
		if (start == 1'b0 && ^(LEGUP_F_main_BB_0_10) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to cur_state"); $finish; end
	end
	if (((cur_state == LEGUP_F_main_BB_0_10) & (memory_controller_waitrequest == 1'd1))) begin
		cur_state <= LEGUP_F_main_BB_0_10;
		if (start == 1'b0 && ^(LEGUP_F_main_BB_0_10) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to cur_state"); $finish; end
	end
	if (((cur_state == LEGUP_F_main_BB_0_10) & (memory_controller_waitrequest == 1'd0))) begin
		cur_state <= LEGUP_F_main_BB_0_11;
		if (start == 1'b0 && ^(LEGUP_F_main_BB_0_11) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to cur_state"); $finish; end
	end
	if (((cur_state == LEGUP_F_main_BB_0_11) & (memory_controller_waitrequest == 1'd1))) begin
		cur_state <= LEGUP_F_main_BB_0_11;
		if (start == 1'b0 && ^(LEGUP_F_main_BB_0_11) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to cur_state"); $finish; end
	end
	if (((cur_state == LEGUP_F_main_BB_0_11) & (memory_controller_waitrequest == 1'd0))) begin
		cur_state <= LEGUP_function_call_12;
		if (start == 1'b0 && ^(LEGUP_function_call_12) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to cur_state"); $finish; end
	end
	if (((cur_state == LEGUP_function_call_12) & (memory_controller_waitrequest == 1'd1))) begin
		cur_state <= LEGUP_function_call_12;
		if (start == 1'b0 && ^(LEGUP_function_call_12) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to cur_state"); $finish; end
	end
	if ((((cur_state == LEGUP_function_call_12) & (memory_controller_waitrequest == 1'd0)) & (funcA_finish_final == 1'd1))) begin
		cur_state <= LEGUP_F_main_BB_0_13;
		if (start == 1'b0 && ^(LEGUP_F_main_BB_0_13) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to cur_state"); $finish; end
	end
	if ((((cur_state == LEGUP_function_call_12) & (memory_controller_waitrequest == 1'd0)) & (funcA_finish_final == 1'd0))) begin
		cur_state <= LEGUP_function_call_12;
		if (start == 1'b0 && ^(LEGUP_function_call_12) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to cur_state"); $finish; end
	end
	if (((cur_state == LEGUP_F_main_BB_0_13) & (memory_controller_waitrequest == 1'd1))) begin
		cur_state <= LEGUP_F_main_BB_0_13;
		if (start == 1'b0 && ^(LEGUP_F_main_BB_0_13) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to cur_state"); $finish; end
	end
	if ((((cur_state == LEGUP_F_main_BB_0_13) & (memory_controller_waitrequest == 1'd0)) & (main_0_13 == 1'd1))) begin
		cur_state <= LEGUP_F_main_BB_14_14;
		if (start == 1'b0 && ^(LEGUP_F_main_BB_14_14) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to cur_state"); $finish; end
	end
	if ((((cur_state == LEGUP_F_main_BB_0_13) & (memory_controller_waitrequest == 1'd0)) & (main_0_13 == 1'd0))) begin
		cur_state <= LEGUP_F_main_BB_16_15;
		if (start == 1'b0 && ^(LEGUP_F_main_BB_16_15) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to cur_state"); $finish; end
	end
	if (((cur_state == LEGUP_F_main_BB_14_14) & (memory_controller_waitrequest == 1'd1))) begin
		cur_state <= LEGUP_F_main_BB_14_14;
		if (start == 1'b0 && ^(LEGUP_F_main_BB_14_14) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to cur_state"); $finish; end
	end
	if (((cur_state == LEGUP_F_main_BB_14_14) & (memory_controller_waitrequest == 1'd0))) begin
		cur_state <= LEGUP_F_main_BB_18_16;
		if (start == 1'b0 && ^(LEGUP_F_main_BB_18_16) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to cur_state"); $finish; end
	end
	if (((cur_state == LEGUP_F_main_BB_16_15) & (memory_controller_waitrequest == 1'd1))) begin
		cur_state <= LEGUP_F_main_BB_16_15;
		if (start == 1'b0 && ^(LEGUP_F_main_BB_16_15) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to cur_state"); $finish; end
	end
	if (((cur_state == LEGUP_F_main_BB_16_15) & (memory_controller_waitrequest == 1'd0))) begin
		cur_state <= LEGUP_F_main_BB_18_16;
		if (start == 1'b0 && ^(LEGUP_F_main_BB_18_16) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to cur_state"); $finish; end
	end
	if (((cur_state == LEGUP_F_main_BB_18_16) & (memory_controller_waitrequest == 1'd1))) begin
		cur_state <= LEGUP_F_main_BB_18_16;
		if (start == 1'b0 && ^(LEGUP_F_main_BB_18_16) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to cur_state"); $finish; end
	end
	if (((cur_state == LEGUP_F_main_BB_18_16) & (memory_controller_waitrequest == 1'd0))) begin
		cur_state <= LEGUP_0;
		if (start == 1'b0 && ^(LEGUP_0) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to cur_state"); $finish; end
	end
	if ((reset == 1'd1)) begin
		cur_state <= 5'd0;
		if (start == 1'b0 && ^(5'd0) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to cur_state"); $finish; end
	end
end
always @(*) begin
	/* main: %0*/
...
always @(*) begin
	...
	/*   %8 = load volatile i32* getelementptr inbounds ([10 x i32]* @memA, i32 0, i32 7), align 4, !tbaa !1*/
		main_0_8 = memory_controller_out_b[31:0];
end
always @(posedge clk) begin
	/* main: %0*/
	/*   %8 = load volatile i32* getelementptr inbounds ([10 x i32]* @memA, i32 0, i32 7), align 4, !tbaa !1*/
...
always @(*) begin
	...
	/*   %9 = load volatile i32* getelementptr inbounds ([10 x i32]* @memA, i32 0, i32 8), align 4, !tbaa !1*/
		main_0_9 = memory_controller_out_a[31:0];
end
always @(posedge clk) begin
	/* main: %0*/
	/*   %9 = load volatile i32* getelementptr inbounds ([10 x i32]* @memA, i32 0, i32 8), align 4, !tbaa !1*/
...
always @(*) begin
	...
	/*   %10 = load volatile i32* getelementptr inbounds ([10 x i32]* @memA, i32 0, i32 9), align 4, !tbaa !1*/
		main_0_10 = memory_controller_out_b[31:0];
end
always @(posedge clk) begin
	/* main: %0*/
	/*   %10 = load volatile i32* getelementptr inbounds ([10 x i32]* @memA, i32 0, i32 9), align 4, !tbaa !1*/
...
always @(posedge clk) begin
	/* main: %0*/
	/*   %11 = tail call fastcc i32 @funcA() #2*/
	if ((cur_state == LEGUP_F_main_BB_0_11)) begin
		funcA_start <= 1'd1;
...
always @(posedge clk) begin
	if ((reset | (cur_state == LEGUP_F_main_BB_0_11))) begin
...
always @(posedge clk) begin
	...
	/* main: %18*/
	/*   ret i32 %11*/
	if ((cur_state == LEGUP_F_main_BB_18_16)) begin
		finish <= (memory_controller_waitrequest == 1'd0);
		if (start == 1'b0 && ^((memory_controller_waitrequest == 1'd0)) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to finish"); $finish; end
	end
end
always @(*) begin
	...
	if ((cur_state == LEGUP_F_main_BB_0_8)) begin
		memory_controller_enable_a = 1'd1;
	end
	/* main: %0*/
	...
	if ((cur_state == LEGUP_F_main_BB_0_10)) begin
		memory_controller_enable_a = 1'd1;
	end
end
always @(*) begin
	...
	/*   %11 = tail call fastcc i32 @funcA() #2*/
	if ((cur_state == LEGUP_function_call_12)) begin
		memory_controller_address_a[`MEMORY_CONTROLLER_ADDR_SIZE-1:0] = funcA_memory_controller_address_a;
	end
	/* main: %0*/
	/*   %11 = tail call fastcc i32 @funcA() #2*/
	if ((cur_state == LEGUP_function_call_12)) begin
	...
	/*   %1 = load volatile i32* getelementptr inbounds ([10 x i32]* @memA, i32 0, i32 0), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_main_BB_0_1)) begin
		memory_controller_address_a = `TAG_g_memA_a;
	end
	/* main: %0*/
	/*   %3 = load volatile i32* getelementptr inbounds ([10 x i32]* @memA, i32 0, i32 2), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_main_BB_0_2)) begin
		memory_controller_address_a = (`TAG_g_memA_a + (4 * 32'd2));
	end
	/* main: %0*/
	/*   %5 = load volatile i32* getelementptr inbounds ([10 x i32]* @memA, i32 0, i32 4), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_main_BB_0_3)) begin
		memory_controller_address_a = (`TAG_g_memA_a + (4 * 32'd4));
	end
	/* main: %0*/
	/*   %7 = load volatile i32* getelementptr inbounds ([10 x i32]* @memA, i32 0, i32 6), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_main_BB_0_4)) begin
		memory_controller_address_a = (`TAG_g_memA_a + (4 * 32'd6));
	end
	/* main: %0*/
	/*   %9 = load volatile i32* getelementptr inbounds ([10 x i32]* @memA, i32 0, i32 8), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_main_BB_0_5)) begin
		memory_controller_address_a = (`TAG_g_memA_a + (4 * 32'd8));
	end
	/* main: %0*/
	/*   store volatile i32 %1, i32* getelementptr inbounds ([10 x i32]* @memB, i32 0, i32 0), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_main_BB_0_6)) begin
...
always @(*) begin
	...
	/*   %11 = tail call fastcc i32 @funcA() #2*/
	if ((cur_state == LEGUP_function_call_12)) begin
		memory_controller_in_a[`MEMORY_CONTROLLER_DATA_SIZE-1:0] = funcA_memory_controller_in_a;
	end
	/* main: %0*/
	/*   %11 = tail call fastcc i32 @funcA() #2*/
	if ((cur_state == LEGUP_function_call_12)) begin
	...
	/*   store volatile i32 %3, i32* getelementptr inbounds ([10 x i32]* @memB, i32 0, i32 2), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_main_BB_0_7)) begin
		memory_controller_in_a = main_0_3_reg;
	end
	/* main: %0*/
	/*   store volatile i32 %5, i32* getelementptr inbounds ([10 x i32]* @memB, i32 0, i32 4), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_main_BB_0_8)) begin
		memory_controller_in_a = main_0_5_reg;
	end
	/* main: %0*/
	/*   store volatile i32 %7, i32* getelementptr inbounds ([10 x i32]* @memB, i32 0, i32 6), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_main_BB_0_9)) begin
		memory_controller_in_a = main_0_7_reg;
	end
	/* main: %0*/
	/*   store volatile i32 %9, i32* getelementptr inbounds ([10 x i32]* @memB, i32 0, i32 8), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_main_BB_0_10)) begin
		memory_controller_in_a = main_0_9_reg;
	end
end
always @(*) begin
	memory_controller_size_a = 1'd0;
	if ((cur_state == LEGUP_function_call_12)) begin
		memory_controller_size_a[1:0] = funcA_memory_controller_size_a;
	end
	/* main: %0*/
	/*   %11 = tail call fastcc i32 @funcA() #2*/
	if ((cur_state == LEGUP_function_call_12)) begin
...
always @(*) begin
	...
	/*   %11 = tail call fastcc i32 @funcA() #2*/
	if ((cur_state == LEGUP_function_call_12)) begin
		memory_controller_address_b[`MEMORY_CONTROLLER_ADDR_SIZE-1:0] = funcA_memory_controller_address_b;
	end
	/* main: %0*/
	/*   %11 = tail call fastcc i32 @funcA() #2*/
	if ((cur_state == LEGUP_function_call_12)) begin
	...
	/*   %2 = load volatile i32* getelementptr inbounds ([10 x i32]* @memA, i32 0, i32 1), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_main_BB_0_1)) begin
		memory_controller_address_b = (`TAG_g_memA_a + (4 * 32'd1));
	end
	/* main: %0*/
	/*   %4 = load volatile i32* getelementptr inbounds ([10 x i32]* @memA, i32 0, i32 3), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_main_BB_0_2)) begin
		memory_controller_address_b = (`TAG_g_memA_a + (4 * 32'd3));
	end
	/* main: %0*/
	/*   %6 = load volatile i32* getelementptr inbounds ([10 x i32]* @memA, i32 0, i32 5), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_main_BB_0_3)) begin
		memory_controller_address_b = (`TAG_g_memA_a + (4 * 32'd5));
	end
	/* main: %0*/
	/*   %8 = load volatile i32* getelementptr inbounds ([10 x i32]* @memA, i32 0, i32 7), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_main_BB_0_4)) begin
		memory_controller_address_b = (`TAG_g_memA_a + (4 * 32'd7));
	end
	/* main: %0*/
	/*   %10 = load volatile i32* getelementptr inbounds ([10 x i32]* @memA, i32 0, i32 9), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_main_BB_0_5)) begin
		memory_controller_address_b = (`TAG_g_memA_a + (4 * 32'd9));
	end
	/* main: %0*/
	/*   store volatile i32 %2, i32* getelementptr inbounds ([10 x i32]* @memB, i32 0, i32 1), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_main_BB_0_6)) begin
...
always @(*) begin
	...
	/*   %11 = tail call fastcc i32 @funcA() #2*/
	if ((cur_state == LEGUP_function_call_12)) begin
		memory_controller_in_b[`MEMORY_CONTROLLER_DATA_SIZE-1:0] = funcA_memory_controller_in_b;
	end
	/* main: %0*/
	/*   %11 = tail call fastcc i32 @funcA() #2*/
	if ((cur_state == LEGUP_function_call_12)) begin
	...
	/*   store volatile i32 %2, i32* getelementptr inbounds ([10 x i32]* @memB, i32 0, i32 1), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_main_BB_0_6)) begin
		memory_controller_in_b = main_0_2_reg;
	end
	/* main: %0*/
	/*   store volatile i32 %4, i32* getelementptr inbounds ([10 x i32]* @memB, i32 0, i32 3), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_main_BB_0_7)) begin
		memory_controller_in_b = main_0_4_reg;
	end
	/* main: %0*/
	/*   store volatile i32 %6, i32* getelementptr inbounds ([10 x i32]* @memB, i32 0, i32 5), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_main_BB_0_8)) begin
		memory_controller_in_b = main_0_6_reg;
	end
	/* main: %0*/
	/*   store volatile i32 %8, i32* getelementptr inbounds ([10 x i32]* @memB, i32 0, i32 7), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_main_BB_0_9)) begin
		memory_controller_in_b = main_0_8_reg;
	end
	/* main: %0*/
	/*   store volatile i32 %10, i32* getelementptr inbounds ([10 x i32]* @memB, i32 0, i32 9), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_main_BB_0_10)) begin
		memory_controller_in_b = main_0_10_reg;
	end
end
always @(*) begin
	memory_controller_size_b = 1'd0;
	if ((cur_state == LEGUP_function_call_12)) begin
		memory_controller_size_b[1:0] = funcA_memory_controller_size_b;
	end
	/* main: %0*/
	/*   %11 = tail call fastcc i32 @funcA() #2*/
	if ((cur_state == LEGUP_function_call_12)) begin
