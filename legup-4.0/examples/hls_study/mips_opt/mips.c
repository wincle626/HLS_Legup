...
volatile int A[8] = { 22, 5, -9, 3, -17, 38, 0, 11 };
volatile int outData[8] = { -17, -9, 0, 3, 5, 11, 22, 38 };
...
void mips_call(int reg[32], unsigned long m_imem[44], int n_inst[1], int dmem[64])
{
	long long hilo;
	int Hi;
	int Lo;
